...
let cli1 = new Cliente('Natalia Gomes', 'Nat G', new CPF('45454545454',new Date(25,11,1975)), 'Feminino')
let cli2 = new Cliente('Ana Santos', 'Ana S', new CPF('89421565454',new Date(15,3,1985)), 'Feminino')
let cli3 = new Cliente('Luiz Couto', 'Luiz C', new CPF('49478542453',new Date(18,7,1988)), 'Masculino')
let cli4 = new Cliente('Isabela Santos', 'Isa S', new CPF('73454542354',new Date(24,8,1982)), 'Feminino')
let cli5 = new Cliente('João Silva', 'João S', new CPF('28426645454',new Date(3,2,1968)), 'Masculino')
let cli6 = new Cliente('Pietra Almeida', 'Pietra A', new CPF('39454475554',new Date(8,12,1990)), 'Feminino')
let cli7 = new Cliente('Heloisa Cabral', 'Heloisa C', new CPF('14454877456',new Date(27,7,1986)), 'Feminino')
let cli8 = new Cliente('Luiza Ferreira', 'Luiza F', new CPF('52452245451',new Date(30,1,1992)), 'Feminino')
let cli9 = new Cliente('Iago Chaves', 'Iago C', new CPF('11454445458',new Date(14,8,1955)), 'Masculino')
let cli10 = new Cliente('Noemia Carvalho', 'Noemia C', new CPF('31454745895',new Date(7,5,19881)), 'Feminino')
let cli11 = new Cliente('Dalva Veloso', 'Dalva V', new CPF('56554745895',new Date(29,6,1992)), 'Feminino')
